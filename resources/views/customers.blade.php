    ...
    <div class="row">
        ...
        @foreach($customers as $customer)
            ...
            <div class="card small">
                ...
                <p><b>@lang('messages.customers.email'):</b> {{$customer->email}}</p>
                </div>
                <div class="card-action">
                <a href="{{route('customers.tickets', ['customer' => $customer])}}" class="teal-text">@lang('messages.customers.tickets')</a>
                </div>
            </div>
            </div>
        @endforeach
